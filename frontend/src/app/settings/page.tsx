...
import { 
  ...
  Settings, HelpCircle, ShieldAlert, Check
} from "lucide-react";
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 self-end md:self-center">
                      ...
                      <button
                        ...
                        className="p-2 bg-slate-950 border border-slate-900 hover:bg-red-500/10 text-red-450 hover:text-red-300 rounded-lg transition duration-150"
